...
## コンストラクタ 関数 [#constructor-function]
...
## 二重構文コンストラクタ: new.target [#dual-syntax-constructors-new-target]
...
## コンストラクタからの返却 [#return-from-constructors]
...
## コンストラクタの中のメソッド [#methods-in-constructor]
